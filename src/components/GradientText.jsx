...
export default function GradientText({
    ...
    return (
        <motion.div
            className={`relative inline-block cursor-pointer ${showBorder ? 'py-1 px-2 rounded-[1.25rem] backdrop-blur font-medium transition-shadow duration-500 overflow-hidden' : ''} ${className}`}
